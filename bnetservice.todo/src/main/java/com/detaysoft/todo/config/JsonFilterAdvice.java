...
@ControllerAdvice
public class JsonFilterAdvice implements ResponseBodyAdvice<List<Map<String, Object>>> {
    @Override
    ...
    @Override
    public List<Map<String, Object>> beforeBodyWrite(List<Map<String, Object>> body, MethodParameter returnType, MediaType selectedContentType, Class<? extends
